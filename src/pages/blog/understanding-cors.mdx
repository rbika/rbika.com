export const meta = {
  ...
  coverImage: '/images/blog/understanding-cors-cover.jpg',
}
...
<picture>
  <source
    ...
    srcset="/images/blog/understanding-cors-1-sm.svg"
  />
  <img src="/images/blog/understanding-cors-1.svg" alt="CORS success flow" />
</picture>
<picture>
  <source
    media="(max-width: 576px)"
    srcset="/images/blog/understanding-cors-2-sm.svg"
  />
  <img src="/images/blog/understanding-cors-2.svg" alt="CORS error flow" />
</picture>
...
<picture>
  <source
    media="(max-width: 576px)"
    srcset="/images/blog/understanding-cors-3-sm.svg"
  />
  <img
    src="/images/blog/understanding-cors-3.svg"
...
<picture>
  <source
    media="(max-width: 576px)"
    srcset="/images/blog/understanding-cors-4-sm.svg"
  />
  <img
    src="/images/blog/understanding-cors-4.svg"
