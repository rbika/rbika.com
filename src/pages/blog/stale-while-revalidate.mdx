export const meta = {
  ...
  coverImage:
    '/images/blog/stale-while-revalidate/stale-while-revalidate-cover.svg',
}
...
<picture>
  <img
    src="/images/blog/stale-while-revalidate/cache-timeline.svg"
    alt="Cache timeline"
  />
</picture>
...
<div className="flex justify-center items-center rounded-md bg-[#2f3340] px-2">
  <img
    src="/images/blog/stale-while-revalidate/request-no-cache-expired-cache.svg"
...
<div className="flex justify-center items-center rounded-md bg-[#2f3340] px-2">
  <img
    src="/images/blog/stale-while-revalidate/request-fresh-cache.svg"
...
<div className="flex justify-center items-center rounded-md bg-[#2f3340] px-2">
  <img
    src="/images/blog/stale-while-revalidate/request-stale-cache.svg"
